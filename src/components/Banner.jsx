      ...
      >
        <div className="banner-content-wrapper">
          <div className="banner-content">
            ...
            {trailer ? 
              <button className="watch-button" type="button" onClick={handleClick}>
                <FontAwesomeIcon
                  icon={faPlay}
        ...
        <div className="trailer-popup">
          ...
          <iframe width="1150" height="550" src={`https://www.youtube.com/embed/${trailer}`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
